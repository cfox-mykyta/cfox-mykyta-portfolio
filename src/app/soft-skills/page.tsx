...
const ProgressBar: React.FC<{ score: string; maxScore: number }> = ({ score, maxScore }) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {skills.map((skill, index) => (
              <div key={index} className="bg-zinc-800 p-6 rounded-lg shadow-md hover:shadow-lg hover:bg-zinc-700 transition duration-300">
                ...
                <ProgressBar score={skill.score} maxScore={skill.maxScore} />
              </div>
            ))}
            {certificates.map((certificate, index) => (
              <div key={index} className="bg-zinc-800 p-6 rounded-lg shadow-md hover:shadow-lg hover:bg-zinc-700 transition duration-300">
                ...
                <ProgressBar score={certificate.score} maxScore={certificate.maxScore} />
              </div>
            ))}
          </div>
        </div>
